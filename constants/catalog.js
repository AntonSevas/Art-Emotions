// Создаем массив данных в каталоге из конкретных переменных

// Это все мы скопировали потом в папку server json, после в папке index js создаем let catalog, вместо того что здесь. И удаляем файл

// в файле каталог.json убираем const catalog, все ключи и данные заключаем в двойные кавычки. последнюю запятую тоже надо убрать
